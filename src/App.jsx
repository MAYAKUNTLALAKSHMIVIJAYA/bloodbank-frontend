...
class App extends Component {
    ...
    userRegistrtaion()
    {
        ...
        callApi("POST","http://localhost:30088/users/signup",data,this.getResponse);
    ...
    forgetpassword()
    {
        ...
        let url="http://localhost:30088/users/forgetpassword/"+username.value;
    ...
    signin()
    {
        ...
        callApi("POST", "http://localhost:30088/users/signin", data, this.signinResponse);
    }
    signinResponse(res)
    {
        let rdata = res.split('::');
